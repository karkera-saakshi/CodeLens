export default function DailyChallenge() {
  return (
    <div className="w-full px-4 sm:px-6 py-16 sm:py-20 md:py-32 min-h-screen flex flex-col justify-center items-center border-b-[4px] border-black bg-white overflow-hidden">
      <div className="max-w-4xl w-full border-[4px] border-black p-6 sm:p-12 md:p-16 shadow-[4px_4px_0_0_rgba(0,0,0,1)] sm:shadow-[8px_8px_0_0_rgba(0,0,0,1)] md:shadow-[24px_24px_0_0_rgba(0,0,0,1)] text-center bg-white">
