export default function DataPrivacy() {
  return (
    <section className="w-full px-4 sm:px-6 py-16 sm:py-20 md:py-32 min-h-screen flex flex-col justify-center items-center border-b-[4px] border-black bg-black text-white overflow-hidden">
      <div className="max-w-6xl w-full mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 text-left mt-8 sm:mt-16 w-full">
          <div className="border-[4px] border-white p-6 sm:p-10 shadow-[4px_4px_0_0_rgba(255,255,255,0.2)] sm:shadow-[8px_8px_0_0_rgba(255,255,255,0.2)] md:shadow-[12px_12px_0_0_rgba(255,255,255,0.2)] md:hover:-translate-y-2 transition-transform w-full">
