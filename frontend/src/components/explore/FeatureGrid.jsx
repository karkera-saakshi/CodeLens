      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-12 w-full">
          {['Unified Metrics', 'AI Guidance', 'Actionable Roadmap'].map((feature, idx) => (
            <div key={idx} className="border-[4px] border-black p-6 sm:p-10 shadow-[4px_4px_0_0_rgba(0,0,0,1)] sm:shadow-[8px_8px_0_0_rgba(0,0,0,1)] md:hover:-translate-y-2 md:hover:shadow-[16px_16px_0_0_rgba(0,0,0,1)] transition-transform bg-white w-full">
