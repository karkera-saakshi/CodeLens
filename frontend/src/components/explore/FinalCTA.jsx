...
export default function FinalCTA() {
  return (
    <div className="w-full px-4 sm:px-6 py-16 sm:py-20 md:py-32 min-h-screen border-b-[4px] border-black bg-black text-center text-white flex flex-col items-center justify-center overflow-hidden">
