      ...
      <div className="max-w-7xl w-full mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
        ...
        <div className="flex-1 w-full grid grid-cols-1 gap-4 sm:gap-8">
          {['GitHub', 'LeetCode', 'Codeforces'].map(plat => (
            <div key={plat} className="w-full p-4 sm:p-8 border-[4px] border-black font-black uppercase tracking-widest text-lg sm:text-2xl text-center shadow-[4px_4px_0_0_rgba(0,0,0,1)] sm:shadow-[8px_8px_0_0_rgba(0,0,0,1)] break-words">
              {plat} Integration
            </div>
          ))}
        </div>
