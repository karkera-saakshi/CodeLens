    ...
    <div className="w-full px-4 sm:px-6 py-16 sm:py-20 md:py-32 min-h-screen flex flex-col justify-center items-center border-b-[4px] border-black bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 w-full">
          <div className="border-[4px] border-black p-6 sm:p-12 shadow-[4px_4px_0_0_rgba(0,0,0,1)] sm:shadow-[8px_8px_0_0_rgba(0,0,0,1)] md:shadow-[16px_16px_0_0_rgba(0,0,0,1)] md:hover:-translate-y-2 transition-transform w-full">
          ...
          <div className="border-[4px] border-black p-6 sm:p-12 bg-black text-white shadow-[4px_4px_0_0_rgba(200,200,200,1)] sm:shadow-[8px_8px_0_0_rgba(200,200,200,1)] md:hover:-translate-y-2 transition-transform w-full">
